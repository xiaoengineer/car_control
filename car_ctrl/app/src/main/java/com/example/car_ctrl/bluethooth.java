...
public class bluethooth extends AppCompatActivity {
        ...
        mReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if (BluetoothDevice.ACTION_FOUND.equals(action)) {
                    ...
                    arrayAdapter1 = new ArrayAdapter<String>(bluethooth.this,
    ...
    protected  void onResume(){
        ...
        listView1.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                ...
                new AlertDialog.Builder(bluethooth.this)
                        .setIcon(R.drawable.ic_launcher_background).setTitle("连接此设备？")
        ...
        switch (id) {
            case 0:
                if (!btAdapter.isEnabled()) {
                    btAdapter.enable();
                    Toast.makeText(bluethooth.this, "蓝牙开启中", Toast.LENGTH_SHORT)
                            .show();
                }
                break;
            case 1:
            ...
            case 2:
                if (btAdapter.isEnabled()) {
                    ...
                    Toast.makeText(bluethooth.this, "开始扫描", Toast.LENGTH_SHORT)
                            .show();
                    progressBar.setVisibility(ProgressBar.VISIBLE);
                } else {
                    Toast.makeText(bluethooth.this, "请打开蓝牙", Toast.LENGTH_SHORT)
                            .show();
            ...
            case 3:
                // 如果连接成功，点击即可进入控制台
                if (isConnect) {
                    Intent intent = new Intent(bluethooth.this,bluethooth.class);
                    startActivity(intent);
                } else {
                    Toast.makeText(bluethooth.this, "请先连接蓝牙", Toast.LENGTH_LONG)
                            .show();
                }
                break;
            ...
            case 4:
                if (isConnect) {
                    Intent intent = new Intent(bluethooth.this,
                            MainActivity.class);
                    startActivity(intent);
                } else {
                    Toast.makeText(bluethooth.this, "请先连接蓝牙", Toast.LENGTH_LONG)
